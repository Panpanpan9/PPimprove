...
# 为了让 Tools.rgetattr(Dataset, ...) 能够找到这个类，它必须在 BiFusev2/Dataset 包中被暴露出来。
# BiFusev2/Dataset/__init__.py：from .SelfSupervisedDataset import SelfSupervisedDataset # <--- 这里导出了类
...
class MyTqdm:
    ...
    def __init__(self, obj, print_step=1000, total=None):
        self.obj = iter(obj)
